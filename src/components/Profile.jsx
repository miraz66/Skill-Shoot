      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="max-w-md pr-10">
            <div>
              <h1 className="text-4xl text-current font-semibold tracking-tight">
                Why do we <span className="text-secondary">exist?</span>
              </h1>
              <p className="pt-4 text-muted max-md:text-sm font-normal leading-9">
            ...
            <div className="py-6 flex items-center gap-4">
              ...
              <div>
                <h4 className="text-current font-semibold">Jerony Pulquosta</h4>
                <p className="text-muted text-sm font-normal tracking-tight">
                  CEO Skill Shoot
                </p>
              </div>
            </div>
            ...
            <div className="pt-8 flex gap-10">
              <div>
                <p className="text-current text-4xl font-semibold tracking-tighter">
                  100+
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gird-rows-2 gap-10">
            <div>
              <img src={Profile_image_1} alt="Group image" />
              <div>
                <h6 className="pt-6 pb-4 text-2xl text-primary font-semibold tracking-tight">
            ...
            <div>
              <img src={Profile_image_2} alt="Group image" />
              <div>
                <h6 className="pt-6 pb-4 text-2xl text-primary font-semibold tracking-tight">
            ...
            <div>
              <img src={Profile_image_3} alt="Group image" />
              <div>
                <h6 className="pt-6 pb-4 text-2xl text-primary font-semibold tracking-tight">
                  Video Quality
                </h6>
            ...
            <div>
              <img src={Profile_image_4} alt="Group image" />
              <div>
                <h6 className="pt-6 pb-4 text-2xl text-primary font-semibold tracking-tight">
                  High Price
                </h6>
